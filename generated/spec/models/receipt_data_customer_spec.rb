...
# Unit tests for Yookassa::ReceiptDataCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptDataCustomer do
  #let(:instance) { Yookassa::ReceiptDataCustomer.new }

  describe 'test an instance of ReceiptDataCustomer' do
    it 'should create an instance of ReceiptDataCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptDataCustomer)
    end
  end
