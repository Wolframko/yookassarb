...
# Unit tests for Yookassa::PersonalData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PersonalData do
  #let(:instance) { Yookassa::PersonalData.new }

  describe 'test an instance of PersonalData' do
    it 'should create an instance of PersonalData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PersonalData)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["waiting_for_operation", "active", "canceled"])
