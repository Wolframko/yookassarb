...
# Unit tests for Yookassa::PaymentMethodSbp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodSbp do
  #let(:instance) { Yookassa::PaymentMethodSbp.new }

  describe 'test an instance of PaymentMethodSbp' do
    it 'should create an instance of PaymentMethodSbp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodSbp)
    end
  end

  describe 'test attribute "sbp_operation_id"' do
    it 'should work' do
