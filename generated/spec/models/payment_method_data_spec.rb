...
# Unit tests for Yookassa::PaymentMethodData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodData do
  #let(:instance) { Yookassa::PaymentMethodData.new }

  describe 'test an instance of PaymentMethodData' do
    it 'should create an instance of PaymentMethodData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodData)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_card", "cash", "sberbank", "tinkoff_bank", "yoo_money", "mobile_balance", "b2b_sberbank", "sbp", "sber_loan", "electronic_certificate", "sber_bnpl"])
