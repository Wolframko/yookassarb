...
# Unit tests for Yookassa::PaymentInvoiceDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentInvoiceDetails do
  #let(:instance) { Yookassa::PaymentInvoiceDetails.new }

  describe 'test an instance of PaymentInvoiceDetails' do
    it 'should create an instance of PaymentInvoiceDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentInvoiceDetails)
    end
  end
