...
# Unit tests for Yookassa::RefundMethodType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundMethodType do
  #let(:instance) { Yookassa::RefundMethodType.new }

  describe 'test an instance of RefundMethodType' do
    it 'should create an instance of RefundMethodType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundMethodType)
    end
  end
