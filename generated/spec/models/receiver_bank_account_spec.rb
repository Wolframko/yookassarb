...
# Unit tests for Yookassa::ReceiverBankAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiverBankAccount do
  #let(:instance) { Yookassa::ReceiverBankAccount.new }

  describe 'test an instance of ReceiverBankAccount' do
    it 'should create an instance of ReceiverBankAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiverBankAccount)
    end
  end
