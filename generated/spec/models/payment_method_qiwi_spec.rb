...
# Unit tests for Yookassa::PaymentMethodQiwi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodQiwi do
  #let(:instance) { Yookassa::PaymentMethodQiwi.new }

  describe 'test an instance of PaymentMethodQiwi' do
    it 'should create an instance of PaymentMethodQiwi' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodQiwi)
    end
  end
