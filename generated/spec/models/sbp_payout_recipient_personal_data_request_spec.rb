...
# Unit tests for Yookassa::SbpPayoutRecipientPersonalDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SbpPayoutRecipientPersonalDataRequest do
  #let(:instance) { Yookassa::SbpPayoutRecipientPersonalDataRequest.new }

  describe 'test an instance of SbpPayoutRecipientPersonalDataRequest' do
    it 'should create an instance of SbpPayoutRecipientPersonalDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SbpPayoutRecipientPersonalDataRequest)
    end
  end
