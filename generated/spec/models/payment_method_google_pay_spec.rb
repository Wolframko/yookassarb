...
# Unit tests for Yookassa::PaymentMethodGooglePay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodGooglePay do
  #let(:instance) { Yookassa::PaymentMethodGooglePay.new }

  describe 'test an instance of PaymentMethodGooglePay' do
    it 'should create an instance of PaymentMethodGooglePay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodGooglePay)
    end
  end
