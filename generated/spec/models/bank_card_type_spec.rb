...
# Unit tests for Yookassa::BankCardType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BankCardType do
  #let(:instance) { Yookassa::BankCardType.new }

  describe 'test an instance of BankCardType' do
    it 'should create an instance of BankCardType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BankCardType)
    end
  end
