...
# Unit tests for Yookassa::ReceiptItemAgentType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemAgentType do
  #let(:instance) { Yookassa::ReceiptItemAgentType.new }

  describe 'test an instance of ReceiptItemAgentType' do
    it 'should create an instance of ReceiptItemAgentType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemAgentType)
    end
  end
