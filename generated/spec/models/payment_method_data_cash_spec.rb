...
# Unit tests for Yookassa::PaymentMethodDataCash
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataCash do
  #let(:instance) { Yookassa::PaymentMethodDataCash.new }

  describe 'test an instance of PaymentMethodDataCash' do
    it 'should create an instance of PaymentMethodDataCash' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataCash)
    end
  end
