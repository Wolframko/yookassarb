...
# Unit tests for Yookassa::InvoicingBankCardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::InvoicingBankCardData do
  #let(:instance) { Yookassa::InvoicingBankCardData.new }

  describe 'test an instance of InvoicingBankCardData' do
    it 'should create an instance of InvoicingBankCardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::InvoicingBankCardData)
    end
  end
