...
# Unit tests for Yookassa::SavePaymentMethodDataBankCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethodDataBankCard do
  #let(:instance) { Yookassa::SavePaymentMethodDataBankCard.new }

  describe 'test an instance of SavePaymentMethodDataBankCard' do
    it 'should create an instance of SavePaymentMethodDataBankCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethodDataBankCard)
    end
  end
