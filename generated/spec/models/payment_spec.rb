...
# Unit tests for Yookassa::Payment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Payment do
  #let(:instance) { Yookassa::Payment.new }

  describe 'test an instance of Payment' do
    it 'should create an instance of Payment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Payment)
    end
  end
  ...
  describe 'test attribute "authorization_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
