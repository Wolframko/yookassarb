...
# Unit tests for Yookassa::B2bSberbankMixedVatData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::B2bSberbankMixedVatData do
  #let(:instance) { Yookassa::B2bSberbankMixedVatData.new }

  describe 'test an instance of B2bSberbankMixedVatData' do
    it 'should create an instance of B2bSberbankMixedVatData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::B2bSberbankMixedVatData)
    end
  end
