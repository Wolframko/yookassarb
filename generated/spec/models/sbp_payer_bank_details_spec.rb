...
# Unit tests for Yookassa::SbpPayerBankDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SbpPayerBankDetails do
  #let(:instance) { Yookassa::SbpPayerBankDetails.new }

  describe 'test an instance of SbpPayerBankDetails' do
    it 'should create an instance of SbpPayerBankDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SbpPayerBankDetails)
    end
  end
