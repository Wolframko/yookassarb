...
# Unit tests for Yookassa::PaymentMethodStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodStatus do
  #let(:instance) { Yookassa::PaymentMethodStatus.new }

  describe 'test an instance of PaymentMethodStatus' do
    it 'should create an instance of PaymentMethodStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodStatus)
    end
  end
