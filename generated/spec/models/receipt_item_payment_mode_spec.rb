...
# Unit tests for Yookassa::ReceiptItemPaymentMode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemPaymentMode do
  #let(:instance) { Yookassa::ReceiptItemPaymentMode.new }

  describe 'test an instance of ReceiptItemPaymentMode' do
    it 'should create an instance of ReceiptItemPaymentMode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemPaymentMode)
    end
  end
