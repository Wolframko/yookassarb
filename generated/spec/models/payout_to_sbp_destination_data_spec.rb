...
# Unit tests for Yookassa::PayoutToSbpDestinationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToSbpDestinationData do
  #let(:instance) { Yookassa::PayoutToSbpDestinationData.new }

  describe 'test an instance of PayoutToSbpDestinationData' do
    it 'should create an instance of PayoutToSbpDestinationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToSbpDestinationData)
    end
  end
