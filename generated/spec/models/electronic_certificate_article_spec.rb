...
# Unit tests for Yookassa::ElectronicCertificateArticle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateArticle do
  #let(:instance) { Yookassa::ElectronicCertificateArticle.new }

  describe 'test an instance of ElectronicCertificateArticle' do
    it 'should create an instance of ElectronicCertificateArticle' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateArticle)
    end
  end
  ...
  describe 'test attribute "article_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
