...
# Unit tests for Yookassa::PaymentRecipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentRecipient do
  #let(:instance) { Yookassa::PaymentRecipient.new }

  describe 'test an instance of PaymentRecipient' do
    it 'should create an instance of PaymentRecipient' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentRecipient)
    end
  end
