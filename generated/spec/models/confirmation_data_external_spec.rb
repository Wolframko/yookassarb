...
# Unit tests for Yookassa::ConfirmationDataExternal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationDataExternal do
  #let(:instance) { Yookassa::ConfirmationDataExternal.new }

  describe 'test an instance of ConfirmationDataExternal' do
    it 'should create an instance of ConfirmationDataExternal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationDataExternal)
    end
  end
