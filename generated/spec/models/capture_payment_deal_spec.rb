...
# Unit tests for Yookassa::CapturePaymentDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CapturePaymentDeal do
  #let(:instance) { Yookassa::CapturePaymentDeal.new }

  describe 'test an instance of CapturePaymentDeal' do
    it 'should create an instance of CapturePaymentDeal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CapturePaymentDeal)
    end
  end
