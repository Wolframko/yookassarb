...
# Unit tests for Yookassa::PaymentOrderData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOrderData do
  #let(:instance) { Yookassa::PaymentOrderData.new }

  describe 'test an instance of PaymentOrderData' do
    it 'should create an instance of PaymentOrderData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOrderData)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["utilities"])
