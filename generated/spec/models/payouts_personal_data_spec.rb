...
# Unit tests for Yookassa::PayoutsPersonalData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutsPersonalData do
  #let(:instance) { Yookassa::PayoutsPersonalData.new }

  describe 'test an instance of PayoutsPersonalData' do
    it 'should create an instance of PayoutsPersonalData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutsPersonalData)
    end
  end
