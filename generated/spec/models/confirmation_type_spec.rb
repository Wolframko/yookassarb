...
# Unit tests for Yookassa::ConfirmationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationType do
  #let(:instance) { Yookassa::ConfirmationType.new }

  describe 'test an instance of ConfirmationType' do
    it 'should create an instance of ConfirmationType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationType)
    end
  end
