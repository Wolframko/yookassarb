...
# Unit tests for Yookassa::PayoutDestinationDataType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDestinationDataType do
  #let(:instance) { Yookassa::PayoutDestinationDataType.new }

  describe 'test an instance of PayoutDestinationDataType' do
    it 'should create an instance of PayoutDestinationDataType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDestinationDataType)
    end
  end
