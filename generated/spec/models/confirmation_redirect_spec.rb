...
# Unit tests for Yookassa::ConfirmationRedirect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationRedirect do
  #let(:instance) { Yookassa::ConfirmationRedirect.new }

  describe 'test an instance of ConfirmationRedirect' do
    it 'should create an instance of ConfirmationRedirect' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationRedirect)
    end
  end
