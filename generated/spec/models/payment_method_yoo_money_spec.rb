...
# Unit tests for Yookassa::PaymentMethodYooMoney
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodYooMoney do
  #let(:instance) { Yookassa::PaymentMethodYooMoney.new }

  describe 'test an instance of PaymentMethodYooMoney' do
    it 'should create an instance of PaymentMethodYooMoney' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodYooMoney)
    end
  end
