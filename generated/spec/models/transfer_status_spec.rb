...
# Unit tests for Yookassa::TransferStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferStatus do
  #let(:instance) { Yookassa::TransferStatus.new }

  describe 'test an instance of TransferStatus' do
    it 'should create an instance of TransferStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferStatus)
    end
  end
