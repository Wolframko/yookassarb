...
# Unit tests for Yookassa::PaymentMethodWebmoney
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodWebmoney do
  #let(:instance) { Yookassa::PaymentMethodWebmoney.new }

  describe 'test an instance of PaymentMethodWebmoney' do
    it 'should create an instance of PaymentMethodWebmoney' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodWebmoney)
    end
  end
