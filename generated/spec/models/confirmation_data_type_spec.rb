...
# Unit tests for Yookassa::ConfirmationDataType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationDataType do
  #let(:instance) { Yookassa::ConfirmationDataType.new }

  describe 'test an instance of ConfirmationDataType' do
    it 'should create an instance of ConfirmationDataType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationDataType)
    end
  end
