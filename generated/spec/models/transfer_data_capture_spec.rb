...
# Unit tests for Yookassa::TransferDataCapture
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferDataCapture do
  #let(:instance) { Yookassa::TransferDataCapture.new }

  describe 'test an instance of TransferDataCapture' do
    it 'should create an instance of TransferDataCapture' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferDataCapture)
    end
  end
