...
# Unit tests for Yookassa::PayoutToBankCardDestinationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToBankCardDestinationData do
  #let(:instance) { Yookassa::PayoutToBankCardDestinationData.new }

  describe 'test an instance of PayoutToBankCardDestinationData' do
    it 'should create an instance of PayoutToBankCardDestinationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToBankCardDestinationData)
    end
  end
