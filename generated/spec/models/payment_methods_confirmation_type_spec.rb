...
# Unit tests for Yookassa::PaymentMethodsConfirmationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodsConfirmationType do
  #let(:instance) { Yookassa::PaymentMethodsConfirmationType.new }

  describe 'test an instance of PaymentMethodsConfirmationType' do
    it 'should create an instance of PaymentMethodsConfirmationType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodsConfirmationType)
    end
  end
