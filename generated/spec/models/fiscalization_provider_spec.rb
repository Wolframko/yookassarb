...
# Unit tests for Yookassa::FiscalizationProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::FiscalizationProvider do
  #let(:instance) { Yookassa::FiscalizationProvider.new }

  describe 'test an instance of FiscalizationProvider' do
    it 'should create an instance of FiscalizationProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::FiscalizationProvider)
    end
  end
