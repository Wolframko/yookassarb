...
# Unit tests for Yookassa::SavePaymentMethodBankCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethodBankCard do
  #let(:instance) { Yookassa::SavePaymentMethodBankCard.new }

  describe 'test an instance of SavePaymentMethodBankCard' do
    it 'should create an instance of SavePaymentMethodBankCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethodBankCard)
    end
  end
