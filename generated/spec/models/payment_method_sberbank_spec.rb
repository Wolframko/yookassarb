...
# Unit tests for Yookassa::PaymentMethodSberbank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodSberbank do
  #let(:instance) { Yookassa::PaymentMethodSberbank.new }

  describe 'test an instance of PaymentMethodSberbank' do
    it 'should create an instance of PaymentMethodSberbank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodSberbank)
    end
  end
