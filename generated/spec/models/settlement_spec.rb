...
# Unit tests for Yookassa::Settlement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Settlement do
  #let(:instance) { Yookassa::Settlement.new }

  describe 'test an instance of Settlement' do
    it 'should create an instance of Settlement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Settlement)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cashless", "prepayment", "postpayment", "consideration"])
