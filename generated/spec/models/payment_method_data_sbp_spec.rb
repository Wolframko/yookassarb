...
# Unit tests for Yookassa::PaymentMethodDataSbp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataSbp do
  #let(:instance) { Yookassa::PaymentMethodDataSbp.new }

  describe 'test an instance of PaymentMethodDataSbp' do
    it 'should create an instance of PaymentMethodDataSbp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataSbp)
    end
  end
