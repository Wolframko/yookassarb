...
# Unit tests for Yookassa::ConfirmationDataQr
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationDataQr do
  #let(:instance) { Yookassa::ConfirmationDataQr.new }

  describe 'test an instance of ConfirmationDataQr' do
    it 'should create an instance of ConfirmationDataQr' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationDataQr)
    end
  end
