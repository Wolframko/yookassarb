...
# Unit tests for Yookassa::FeeMoment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::FeeMoment do
  #let(:instance) { Yookassa::FeeMoment.new }

  describe 'test an instance of FeeMoment' do
    it 'should create an instance of FeeMoment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::FeeMoment)
    end
  end
