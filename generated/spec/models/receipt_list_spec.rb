...
# Unit tests for Yookassa::ReceiptList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptList do
  #let(:instance) { Yookassa::ReceiptList.new }

  describe 'test an instance of ReceiptList' do
    it 'should create an instance of ReceiptList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptList)
    end
  end
