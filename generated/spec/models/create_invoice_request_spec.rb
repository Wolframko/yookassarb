...
# Unit tests for Yookassa::CreateInvoiceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CreateInvoiceRequest do
  #let(:instance) { Yookassa::CreateInvoiceRequest.new }

  describe 'test an instance of CreateInvoiceRequest' do
    it 'should create an instance of CreateInvoiceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CreateInvoiceRequest)
    end
  end
  ...
  describe 'test attribute "delivery_method_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
