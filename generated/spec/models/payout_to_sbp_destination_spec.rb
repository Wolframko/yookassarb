...
# Unit tests for Yookassa::PayoutToSbpDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToSbpDestination do
  #let(:instance) { Yookassa::PayoutToSbpDestination.new }

  describe 'test an instance of PayoutToSbpDestination' do
    it 'should create an instance of PayoutToSbpDestination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToSbpDestination)
    end
  end
  ...
  describe 'test attribute "recipient_checked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
