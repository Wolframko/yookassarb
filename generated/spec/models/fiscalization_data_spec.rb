...
# Unit tests for Yookassa::FiscalizationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::FiscalizationData do
  #let(:instance) { Yookassa::FiscalizationData.new }

  describe 'test an instance of FiscalizationData' do
    it 'should create an instance of FiscalizationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::FiscalizationData)
    end
  end
