...
# Unit tests for Yookassa::CardDataForPayoutDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CardDataForPayoutDestination do
  #let(:instance) { Yookassa::CardDataForPayoutDestination.new }

  describe 'test an instance of CardDataForPayoutDestination' do
    it 'should create an instance of CardDataForPayoutDestination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CardDataForPayoutDestination)
    end
  end
