...
# Unit tests for Yookassa::PaymentMethodsConfirmation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodsConfirmation do
  #let(:instance) { Yookassa::PaymentMethodsConfirmation.new }

  describe 'test an instance of PaymentMethodsConfirmation' do
    it 'should create an instance of PaymentMethodsConfirmation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodsConfirmation)
    end
  end
