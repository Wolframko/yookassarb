...
# Unit tests for Yookassa::CreatePaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CreatePaymentRequest do
  #let(:instance) { Yookassa::CreatePaymentRequest.new }

  describe 'test an instance of CreatePaymentRequest' do
    it 'should create an instance of CreatePaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CreatePaymentRequest)
    end
  end
  ...
  describe 'test attribute "save_payment_method"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
