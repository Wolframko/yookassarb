...
# Unit tests for Yookassa::SbpRefundMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SbpRefundMethod do
  #let(:instance) { Yookassa::SbpRefundMethod.new }

  describe 'test an instance of SbpRefundMethod' do
    it 'should create an instance of SbpRefundMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SbpRefundMethod)
    end
  end
