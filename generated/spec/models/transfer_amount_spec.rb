...
# Unit tests for Yookassa::TransferAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferAmount do
  #let(:instance) { Yookassa::TransferAmount.new }

  describe 'test an instance of TransferAmount' do
    it 'should create an instance of TransferAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferAmount)
    end
  end
