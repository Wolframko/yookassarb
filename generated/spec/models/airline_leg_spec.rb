...
# Unit tests for Yookassa::AirlineLeg
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::AirlineLeg do
  #let(:instance) { Yookassa::AirlineLeg.new }

  describe 'test an instance of AirlineLeg' do
    it 'should create an instance of AirlineLeg' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::AirlineLeg)
    end
  end

  describe 'test attribute "departure_airport"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "destination_airport"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
