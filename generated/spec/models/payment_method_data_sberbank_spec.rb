...
# Unit tests for Yookassa::PaymentMethodDataSberbank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataSberbank do
  #let(:instance) { Yookassa::PaymentMethodDataSberbank.new }

  describe 'test an instance of PaymentMethodDataSberbank' do
    it 'should create an instance of PaymentMethodDataSberbank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataSberbank)
    end
  end
