...
# Unit tests for Yookassa::TransferDataAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferDataAmount do
  #let(:instance) { Yookassa::TransferDataAmount.new }

  describe 'test an instance of TransferDataAmount' do
    it 'should create an instance of TransferDataAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferDataAmount)
    end
  end
