...
# Unit tests for Yookassa::PaymentMethodTinkoffBank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodTinkoffBank do
  #let(:instance) { Yookassa::PaymentMethodTinkoffBank.new }

  describe 'test an instance of PaymentMethodTinkoffBank' do
    it 'should create an instance of PaymentMethodTinkoffBank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodTinkoffBank)
    end
  end
