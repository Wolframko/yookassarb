...
# Unit tests for Yookassa::RefundRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundRequest do
  #let(:instance) { Yookassa::RefundRequest.new }

  describe 'test an instance of RefundRequest' do
    it 'should create an instance of RefundRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundRequest)
    end
  end
  ...
  describe 'test attribute "refund_method_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
