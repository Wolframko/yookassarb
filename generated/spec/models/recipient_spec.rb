...
# Unit tests for Yookassa::Recipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Recipient do
  #let(:instance) { Yookassa::Recipient.new }

  describe 'test an instance of Recipient' do
    it 'should create an instance of Recipient' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Recipient)
    end
  end
