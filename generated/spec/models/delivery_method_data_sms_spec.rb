...
# Unit tests for Yookassa::DeliveryMethodDataSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodDataSms do
  #let(:instance) { Yookassa::DeliveryMethodDataSms.new }

  describe 'test an instance of DeliveryMethodDataSms' do
    it 'should create an instance of DeliveryMethodDataSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodDataSms)
    end
  end
