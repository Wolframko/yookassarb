...
# Unit tests for Yookassa::RefundMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundMethod do
  #let(:instance) { Yookassa::RefundMethod.new }

  describe 'test an instance of RefundMethod' do
    it 'should create an instance of RefundMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundMethod)
    end
  end
