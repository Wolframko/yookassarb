...
# Unit tests for Yookassa::DeliveryMethodDataEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodDataEmail do
  #let(:instance) { Yookassa::DeliveryMethodDataEmail.new }

  describe 'test an instance of DeliveryMethodDataEmail' do
    it 'should create an instance of DeliveryMethodDataEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodDataEmail)
    end
  end
