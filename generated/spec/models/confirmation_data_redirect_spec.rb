...
# Unit tests for Yookassa::ConfirmationDataRedirect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationDataRedirect do
  #let(:instance) { Yookassa::ConfirmationDataRedirect.new }

  describe 'test an instance of ConfirmationDataRedirect' do
    it 'should create an instance of ConfirmationDataRedirect' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationDataRedirect)
    end
  end
