...
# Unit tests for Yookassa::Statement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Statement do
  #let(:instance) { Yookassa::Statement.new }

  describe 'test an instance of Statement' do
    it 'should create an instance of Statement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Statement)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["payment_overview"])
