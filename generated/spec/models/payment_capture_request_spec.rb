...
# Unit tests for Yookassa::PaymentCaptureRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentCaptureRequest do
  #let(:instance) { Yookassa::PaymentCaptureRequest.new }

  describe 'test an instance of PaymentCaptureRequest' do
    it 'should create an instance of PaymentCaptureRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentCaptureRequest)
    end
  end
