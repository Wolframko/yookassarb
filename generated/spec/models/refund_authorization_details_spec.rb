...
# Unit tests for Yookassa::RefundAuthorizationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundAuthorizationDetails do
  #let(:instance) { Yookassa::RefundAuthorizationDetails.new }

  describe 'test an instance of RefundAuthorizationDetails' do
    it 'should create an instance of RefundAuthorizationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundAuthorizationDetails)
    end
  end
