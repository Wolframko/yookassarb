...
# Unit tests for Yookassa::DeliveryMethodDataSelf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodDataSelf do
  #let(:instance) { Yookassa::DeliveryMethodDataSelf.new }

  describe 'test an instance of DeliveryMethodDataSelf' do
    it 'should create an instance of DeliveryMethodDataSelf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodDataSelf)
    end
  end
