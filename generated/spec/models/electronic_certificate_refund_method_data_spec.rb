...
# Unit tests for Yookassa::ElectronicCertificateRefundMethodData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateRefundMethodData do
  #let(:instance) { Yookassa::ElectronicCertificateRefundMethodData.new }

  describe 'test an instance of ElectronicCertificateRefundMethodData' do
    it 'should create an instance of ElectronicCertificateRefundMethodData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateRefundMethodData)
    end
  end
