...
# Unit tests for Yookassa::ConfirmationDataMobileApplication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationDataMobileApplication do
  #let(:instance) { Yookassa::ConfirmationDataMobileApplication.new }

  describe 'test an instance of ConfirmationDataMobileApplication' do
    it 'should create an instance of ConfirmationDataMobileApplication' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationDataMobileApplication)
    end
  end
