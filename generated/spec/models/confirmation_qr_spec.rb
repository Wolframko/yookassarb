...
# Unit tests for Yookassa::ConfirmationQr
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationQr do
  #let(:instance) { Yookassa::ConfirmationQr.new }

  describe 'test an instance of ConfirmationQr' do
    it 'should create an instance of ConfirmationQr' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationQr)
    end
  end

  describe 'test attribute "confirmation_data"' do
    it 'should work' do
