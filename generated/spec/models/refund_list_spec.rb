...
# Unit tests for Yookassa::RefundList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundList do
  #let(:instance) { Yookassa::RefundList.new }

  describe 'test an instance of RefundList' do
    it 'should create an instance of RefundList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundList)
    end
  end
