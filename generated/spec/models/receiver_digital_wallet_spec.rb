...
# Unit tests for Yookassa::ReceiverDigitalWallet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiverDigitalWallet do
  #let(:instance) { Yookassa::ReceiverDigitalWallet.new }

  describe 'test an instance of ReceiverDigitalWallet' do
    it 'should create an instance of ReceiverDigitalWallet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiverDigitalWallet)
    end
  end
