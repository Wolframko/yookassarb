...
# Unit tests for Yookassa::PaymentOverviewStatementDeliveryMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOverviewStatementDeliveryMethod do
  #let(:instance) { Yookassa::PaymentOverviewStatementDeliveryMethod.new }

  describe 'test an instance of PaymentOverviewStatementDeliveryMethod' do
    it 'should create an instance of PaymentOverviewStatementDeliveryMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOverviewStatementDeliveryMethod)
    end
  end
