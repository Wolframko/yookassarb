...
# Unit tests for Yookassa::BankCardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BankCardData do
  #let(:instance) { Yookassa::BankCardData.new }

  describe 'test an instance of BankCardData' do
    it 'should create an instance of BankCardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BankCardData)
    end
  end
