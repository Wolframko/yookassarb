...
# Unit tests for Yookassa::DealType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DealType do
  #let(:instance) { Yookassa::DealType.new }

  describe 'test an instance of DealType' do
    it 'should create an instance of DealType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DealType)
    end
  end
