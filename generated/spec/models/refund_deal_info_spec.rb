...
# Unit tests for Yookassa::RefundDealInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundDealInfo do
  #let(:instance) { Yookassa::RefundDealInfo.new }

  describe 'test an instance of RefundDealInfo' do
    it 'should create an instance of RefundDealInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundDealInfo)
    end
  end
