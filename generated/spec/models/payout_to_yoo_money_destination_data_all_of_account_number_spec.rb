...
# Unit tests for Yookassa::PayoutToYooMoneyDestinationDataAllOfAccountNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToYooMoneyDestinationDataAllOfAccountNumber do
  #let(:instance) { Yookassa::PayoutToYooMoneyDestinationDataAllOfAccountNumber.new }

  describe 'test an instance of PayoutToYooMoneyDestinationDataAllOfAccountNumber' do
    it 'should create an instance of PayoutToYooMoneyDestinationDataAllOfAccountNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToYooMoneyDestinationDataAllOfAccountNumber)
    end
  end
