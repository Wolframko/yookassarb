...
# Unit tests for Yookassa::PayoutMethodType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutMethodType do
  #let(:instance) { Yookassa::PayoutMethodType.new }

  describe 'test an instance of PayoutMethodType' do
    it 'should create an instance of PayoutMethodType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutMethodType)
    end
  end
