...
# Unit tests for Yookassa::ReceiverMobileBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiverMobileBalance do
  #let(:instance) { Yookassa::ReceiverMobileBalance.new }

  describe 'test an instance of ReceiverMobileBalance' do
    it 'should create an instance of ReceiverMobileBalance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiverMobileBalance)
    end
  end
