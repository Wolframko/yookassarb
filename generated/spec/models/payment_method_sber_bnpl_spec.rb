...
# Unit tests for Yookassa::PaymentMethodSberBnpl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodSberBnpl do
  #let(:instance) { Yookassa::PaymentMethodSberBnpl.new }

  describe 'test an instance of PaymentMethodSberBnpl' do
    it 'should create an instance of PaymentMethodSberBnpl' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodSberBnpl)
    end
  end
