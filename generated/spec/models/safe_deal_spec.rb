...
# Unit tests for Yookassa::SafeDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SafeDeal do
  #let(:instance) { Yookassa::SafeDeal.new }

  describe 'test an instance of SafeDeal' do
    it 'should create an instance of SafeDeal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SafeDeal)
    end
  end
