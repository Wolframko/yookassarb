...
# Unit tests for Yookassa::ElectronicCertificatePaymentData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificatePaymentData do
  #let(:instance) { Yookassa::ElectronicCertificatePaymentData.new }

  describe 'test an instance of ElectronicCertificatePaymentData' do
    it 'should create an instance of ElectronicCertificatePaymentData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificatePaymentData)
    end
  end
