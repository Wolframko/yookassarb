...
# Unit tests for Yookassa::CardRequestDataWithCsc
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CardRequestDataWithCsc do
  #let(:instance) { Yookassa::CardRequestDataWithCsc.new }

  describe 'test an instance of CardRequestDataWithCsc' do
    it 'should create an instance of CardRequestDataWithCsc' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CardRequestDataWithCsc)
    end
  end
