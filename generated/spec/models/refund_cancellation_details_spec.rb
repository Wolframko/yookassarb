...
# Unit tests for Yookassa::RefundCancellationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundCancellationDetails do
  #let(:instance) { Yookassa::RefundCancellationDetails.new }

  describe 'test an instance of RefundCancellationDetails' do
    it 'should create an instance of RefundCancellationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundCancellationDetails)
    end
  end
  ...
  describe 'test attribute "party"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yoo_money", "refund_network"])
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yoo_money_account_closed", "insufficient_funds", "general_decline", "rejected_by_payee", "rejected_by_timeout", "payment_basket_id_not_found", "payment_article_number_not_found", "payment_tru_code_not_found", "too_many_refunding_articles", "some_articles_already_refunded"])
      # validator.allowable_values.each do |value|
