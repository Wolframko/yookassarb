...
# Unit tests for Yookassa::PaymentMethodDataTinkoffBank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataTinkoffBank do
  #let(:instance) { Yookassa::PaymentMethodDataTinkoffBank.new }

  describe 'test an instance of PaymentMethodDataTinkoffBank' do
    it 'should create an instance of PaymentMethodDataTinkoffBank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataTinkoffBank)
    end
  end
