...
# Unit tests for Yookassa::InvoiceCancellationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::InvoiceCancellationDetails do
  #let(:instance) { Yookassa::InvoiceCancellationDetails.new }

  describe 'test an instance of InvoiceCancellationDetails' do
    it 'should create an instance of InvoiceCancellationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::InvoiceCancellationDetails)
    end
  end
  ...
  describe 'test attribute "party"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yoo_money", "merchant"])
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invoice_canceled", "invoice_expired", "general_decline", "payment_canceled", "payment_expired_on_capture"])
      # validator.allowable_values.each do |value|
