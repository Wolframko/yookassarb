...
# Unit tests for Yookassa::PaymentMethodElectronicCertificate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodElectronicCertificate do
  #let(:instance) { Yookassa::PaymentMethodElectronicCertificate.new }

  describe 'test an instance of PaymentMethodElectronicCertificate' do
    it 'should create an instance of PaymentMethodElectronicCertificate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodElectronicCertificate)
    end
  end
