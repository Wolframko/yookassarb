...
# Unit tests for Yookassa::WebhookList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::WebhookList do
  #let(:instance) { Yookassa::WebhookList.new }

  describe 'test an instance of WebhookList' do
    it 'should create an instance of WebhookList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::WebhookList)
    end
  end
