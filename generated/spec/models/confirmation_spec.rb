...
# Unit tests for Yookassa::Confirmation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Confirmation do
  #let(:instance) { Yookassa::Confirmation.new }

  describe 'test an instance of Confirmation' do
    it 'should create an instance of Confirmation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Confirmation)
    end
  end
