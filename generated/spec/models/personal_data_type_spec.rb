...
# Unit tests for Yookassa::PersonalDataType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PersonalDataType do
  #let(:instance) { Yookassa::PersonalDataType.new }

  describe 'test an instance of PersonalDataType' do
    it 'should create an instance of PersonalDataType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PersonalDataType)
    end
  end
