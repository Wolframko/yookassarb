...
# Unit tests for Yookassa::TransferDataPayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferDataPayment do
  #let(:instance) { Yookassa::TransferDataPayment.new }

  describe 'test an instance of TransferDataPayment' do
    it 'should create an instance of TransferDataPayment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferDataPayment)
    end
  end
