...
# Unit tests for Yookassa::InvalidCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::InvalidCredentials do
  #let(:instance) { Yookassa::InvalidCredentials.new }

  describe 'test an instance of InvalidCredentials' do
    it 'should create an instance of InvalidCredentials' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::InvalidCredentials)
    end
  end
  ...
  describe 'test attribute "code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invalid_credentials"])
      # validator.allowable_values.each do |value|
