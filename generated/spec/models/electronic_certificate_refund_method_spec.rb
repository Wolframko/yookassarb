...
# Unit tests for Yookassa::ElectronicCertificateRefundMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateRefundMethod do
  #let(:instance) { Yookassa::ElectronicCertificateRefundMethod.new }

  describe 'test an instance of ElectronicCertificateRefundMethod' do
    it 'should create an instance of ElectronicCertificateRefundMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateRefundMethod)
    end
  end
