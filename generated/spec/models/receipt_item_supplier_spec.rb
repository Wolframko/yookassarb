...
# Unit tests for Yookassa::ReceiptItemSupplier
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemSupplier do
  #let(:instance) { Yookassa::ReceiptItemSupplier.new }

  describe 'test an instance of ReceiptItemSupplier' do
    it 'should create an instance of ReceiptItemSupplier' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemSupplier)
    end
  end
