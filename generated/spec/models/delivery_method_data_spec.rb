...
# Unit tests for Yookassa::DeliveryMethodData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodData do
  #let(:instance) { Yookassa::DeliveryMethodData.new }

  describe 'test an instance of DeliveryMethodData' do
    it 'should create an instance of DeliveryMethodData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodData)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["self", "sms", "email"])
