...
# Unit tests for Yookassa::PaymentMethodMobileBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodMobileBalance do
  #let(:instance) { Yookassa::PaymentMethodMobileBalance.new }

  describe 'test an instance of PaymentMethodMobileBalance' do
    it 'should create an instance of PaymentMethodMobileBalance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodMobileBalance)
    end
  end
