...
# Unit tests for Yookassa::PayoutToYooMoneyDestinationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToYooMoneyDestinationData do
  #let(:instance) { Yookassa::PayoutToYooMoneyDestinationData.new }

  describe 'test an instance of PayoutToYooMoneyDestinationData' do
    it 'should create an instance of PayoutToYooMoneyDestinationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToYooMoneyDestinationData)
    end
  end
