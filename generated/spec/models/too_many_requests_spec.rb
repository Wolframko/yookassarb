...
# Unit tests for Yookassa::TooManyRequests
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TooManyRequests do
  #let(:instance) { Yookassa::TooManyRequests.new }

  describe 'test an instance of TooManyRequests' do
    it 'should create an instance of TooManyRequests' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TooManyRequests)
    end
  end
  ...
  describe 'test attribute "code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["too_many_requests"])
      # validator.allowable_values.each do |value|
