...
# Unit tests for Yookassa::PaymentMethodsConfirmationAttrs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodsConfirmationAttrs do
  #let(:instance) { Yookassa::PaymentMethodsConfirmationAttrs.new }

  describe 'test an instance of PaymentMethodsConfirmationAttrs' do
    it 'should create an instance of PaymentMethodsConfirmationAttrs' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodsConfirmationAttrs)
    end
  end
