...
# Unit tests for Yookassa::SettlementRefundItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SettlementRefundItem do
  #let(:instance) { Yookassa::SettlementRefundItem.new }

  describe 'test an instance of SettlementRefundItem' do
    it 'should create an instance of SettlementRefundItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SettlementRefundItem)
    end
  end
