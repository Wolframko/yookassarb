...
# Unit tests for Yookassa::DeliveryMethodSelf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodSelf do
  #let(:instance) { Yookassa::DeliveryMethodSelf.new }

  describe 'test an instance of DeliveryMethodSelf' do
    it 'should create an instance of DeliveryMethodSelf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodSelf)
    end
  end
