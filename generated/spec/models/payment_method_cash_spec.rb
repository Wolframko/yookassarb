...
# Unit tests for Yookassa::PaymentMethodCash
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodCash do
  #let(:instance) { Yookassa::PaymentMethodCash.new }

  describe 'test an instance of PaymentMethodCash' do
    it 'should create an instance of PaymentMethodCash' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodCash)
    end
  end
