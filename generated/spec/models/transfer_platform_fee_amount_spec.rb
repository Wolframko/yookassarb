...
# Unit tests for Yookassa::TransferPlatformFeeAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferPlatformFeeAmount do
  #let(:instance) { Yookassa::TransferPlatformFeeAmount.new }

  describe 'test an instance of TransferPlatformFeeAmount' do
    it 'should create an instance of TransferPlatformFeeAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferPlatformFeeAmount)
    end
  end
