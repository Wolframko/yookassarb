...
# Unit tests for Yookassa::ConfirmationMobileApplication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationMobileApplication do
  #let(:instance) { Yookassa::ConfirmationMobileApplication.new }

  describe 'test an instance of ConfirmationMobileApplication' do
    it 'should create an instance of ConfirmationMobileApplication' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationMobileApplication)
    end
  end
