...
# Unit tests for Yookassa::ElectronicCertificatePayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificatePayment do
  #let(:instance) { Yookassa::ElectronicCertificatePayment.new }

  describe 'test an instance of ElectronicCertificatePayment' do
    it 'should create an instance of ElectronicCertificatePayment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificatePayment)
    end
  end
