...
# Unit tests for Yookassa::PaymentMethodDataBankCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataBankCard do
  #let(:instance) { Yookassa::PaymentMethodDataBankCard.new }

  describe 'test an instance of PaymentMethodDataBankCard' do
    it 'should create an instance of PaymentMethodDataBankCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataBankCard)
    end
  end
