...
# Unit tests for Yookassa::DeliveryMethodSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodSms do
  #let(:instance) { Yookassa::DeliveryMethodSms.new }

  describe 'test an instance of DeliveryMethodSms' do
    it 'should create an instance of DeliveryMethodSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodSms)
    end
  end
