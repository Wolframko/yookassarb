...
# Unit tests for Yookassa::PaymentMethodApplePay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodApplePay do
  #let(:instance) { Yookassa::PaymentMethodApplePay.new }

  describe 'test an instance of PaymentMethodApplePay' do
    it 'should create an instance of PaymentMethodApplePay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodApplePay)
    end
  end
