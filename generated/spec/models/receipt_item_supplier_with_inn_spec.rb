...
# Unit tests for Yookassa::ReceiptItemSupplierWithInn
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemSupplierWithInn do
  #let(:instance) { Yookassa::ReceiptItemSupplierWithInn.new }

  describe 'test an instance of ReceiptItemSupplierWithInn' do
    it 'should create an instance of ReceiptItemSupplierWithInn' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemSupplierWithInn)
    end
  end
