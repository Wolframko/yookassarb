...
# Unit tests for Yookassa::PaymentMethodInstallments
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodInstallments do
  #let(:instance) { Yookassa::PaymentMethodInstallments.new }

  describe 'test an instance of PaymentMethodInstallments' do
    it 'should create an instance of PaymentMethodInstallments' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodInstallments)
    end
  end
