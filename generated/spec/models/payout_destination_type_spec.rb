...
# Unit tests for Yookassa::PayoutDestinationType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDestinationType do
  #let(:instance) { Yookassa::PayoutDestinationType.new }

  describe 'test an instance of PayoutDestinationType' do
    it 'should create an instance of PayoutDestinationType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDestinationType)
    end
  end
