...
# Unit tests for Yookassa::SavePaymentMethodHolder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethodHolder do
  #let(:instance) { Yookassa::SavePaymentMethodHolder.new }

  describe 'test an instance of SavePaymentMethodHolder' do
    it 'should create an instance of SavePaymentMethodHolder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethodHolder)
    end
  end
