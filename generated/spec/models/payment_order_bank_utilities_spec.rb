...
# Unit tests for Yookassa::PaymentOrderBankUtilities
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOrderBankUtilities do
  #let(:instance) { Yookassa::PaymentOrderBankUtilities.new }

  describe 'test an instance of PaymentOrderBankUtilities' do
    it 'should create an instance of PaymentOrderBankUtilities' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOrderBankUtilities)
    end
  end
  ...
  describe 'test attribute "correspondent_account"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
