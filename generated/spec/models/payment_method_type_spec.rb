...
# Unit tests for Yookassa::PaymentMethodType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodType do
  #let(:instance) { Yookassa::PaymentMethodType.new }

  describe 'test an instance of PaymentMethodType' do
    it 'should create an instance of PaymentMethodType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodType)
    end
  end
