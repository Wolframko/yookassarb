...
# Unit tests for Yookassa::ReceiptAdditionalUserProps
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptAdditionalUserProps do
  #let(:instance) { Yookassa::ReceiptAdditionalUserProps.new }

  describe 'test an instance of ReceiptAdditionalUserProps' do
    it 'should create an instance of ReceiptAdditionalUserProps' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptAdditionalUserProps)
    end
  end
