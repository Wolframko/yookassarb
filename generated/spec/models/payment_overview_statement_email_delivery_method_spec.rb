...
# Unit tests for Yookassa::PaymentOverviewStatementEmailDeliveryMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOverviewStatementEmailDeliveryMethod do
  #let(:instance) { Yookassa::PaymentOverviewStatementEmailDeliveryMethod.new }

  describe 'test an instance of PaymentOverviewStatementEmailDeliveryMethod' do
    it 'should create an instance of PaymentOverviewStatementEmailDeliveryMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOverviewStatementEmailDeliveryMethod)
    end
  end
