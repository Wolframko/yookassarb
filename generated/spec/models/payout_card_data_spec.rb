...
# Unit tests for Yookassa::PayoutCardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutCardData do
  #let(:instance) { Yookassa::PayoutCardData.new }

  describe 'test an instance of PayoutCardData' do
    it 'should create an instance of PayoutCardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutCardData)
    end
  end
