...
# Unit tests for Yookassa::PaymentList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentList do
  #let(:instance) { Yookassa::PaymentList.new }

  describe 'test an instance of PaymentList' do
    it 'should create an instance of PaymentList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentList)
    end
  end
