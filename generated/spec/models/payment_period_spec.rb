...
# Unit tests for Yookassa::PaymentPeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentPeriod do
  #let(:instance) { Yookassa::PaymentPeriod.new }

  describe 'test an instance of PaymentPeriod' do
    it 'should create an instance of PaymentPeriod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentPeriod)
    end
  end
