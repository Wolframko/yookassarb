...
# Unit tests for Yookassa::PostReceiptItemSupplierWithInn
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PostReceiptItemSupplierWithInn do
  #let(:instance) { Yookassa::PostReceiptItemSupplierWithInn.new }

  describe 'test an instance of PostReceiptItemSupplierWithInn' do
    it 'should create an instance of PostReceiptItemSupplierWithInn' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PostReceiptItemSupplierWithInn)
    end
  end
