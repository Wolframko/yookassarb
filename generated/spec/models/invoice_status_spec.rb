...
# Unit tests for Yookassa::InvoiceStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::InvoiceStatus do
  #let(:instance) { Yookassa::InvoiceStatus.new }

  describe 'test an instance of InvoiceStatus' do
    it 'should create an instance of InvoiceStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::InvoiceStatus)
    end
  end
