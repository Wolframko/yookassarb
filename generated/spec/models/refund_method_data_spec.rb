...
# Unit tests for Yookassa::RefundMethodData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundMethodData do
  #let(:instance) { Yookassa::RefundMethodData.new }

  describe 'test an instance of RefundMethodData' do
    it 'should create an instance of RefundMethodData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundMethodData)
    end
  end
