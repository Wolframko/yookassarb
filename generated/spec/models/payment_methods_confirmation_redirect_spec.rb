...
# Unit tests for Yookassa::PaymentMethodsConfirmationRedirect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodsConfirmationRedirect do
  #let(:instance) { Yookassa::PaymentMethodsConfirmationRedirect.new }

  describe 'test an instance of PaymentMethodsConfirmationRedirect' do
    it 'should create an instance of PaymentMethodsConfirmationRedirect' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodsConfirmationRedirect)
    end
  end

  describe 'test attribute "confirmation_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "enforce"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
