...
# Unit tests for Yookassa::PaymentData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentData do
  #let(:instance) { Yookassa::PaymentData.new }

  describe 'test an instance of PaymentData' do
    it 'should create an instance of PaymentData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentData)
    end
  end
