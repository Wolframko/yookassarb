...
# Unit tests for Yookassa::PersonalDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PersonalDataRequest do
  #let(:instance) { Yookassa::PersonalDataRequest.new }

  describe 'test an instance of PersonalDataRequest' do
    it 'should create an instance of PersonalDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PersonalDataRequest)
    end
  end
