...
# Unit tests for Yookassa::ElectronicCertificateRefundDataResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateRefundDataResponse do
  #let(:instance) { Yookassa::ElectronicCertificateRefundDataResponse.new }

  describe 'test an instance of ElectronicCertificateRefundDataResponse' do
    it 'should create an instance of ElectronicCertificateRefundDataResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateRefundDataResponse)
    end
  end
