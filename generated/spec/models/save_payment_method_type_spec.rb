...
# Unit tests for Yookassa::SavePaymentMethodType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethodType do
  #let(:instance) { Yookassa::SavePaymentMethodType.new }

  describe 'test an instance of SavePaymentMethodType' do
    it 'should create an instance of SavePaymentMethodType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethodType)
    end
  end
