...
# Unit tests for Yookassa::ElectronicCertificateApprovedPaymentArticle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateApprovedPaymentArticle do
  #let(:instance) { Yookassa::ElectronicCertificateApprovedPaymentArticle.new }

  describe 'test an instance of ElectronicCertificateApprovedPaymentArticle' do
    it 'should create an instance of ElectronicCertificateApprovedPaymentArticle' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateApprovedPaymentArticle)
    end
  end
  ...
  describe 'test attribute "tru_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "article_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
