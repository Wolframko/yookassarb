...
# Unit tests for Yookassa::PaymentOverviewStatementDeliveryMethodType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOverviewStatementDeliveryMethodType do
  #let(:instance) { Yookassa::PaymentOverviewStatementDeliveryMethodType.new }

  describe 'test an instance of PaymentOverviewStatementDeliveryMethodType' do
    it 'should create an instance of PaymentOverviewStatementDeliveryMethodType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOverviewStatementDeliveryMethodType)
    end
  end
