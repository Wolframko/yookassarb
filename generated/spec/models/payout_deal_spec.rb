...
# Unit tests for Yookassa::PayoutDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDeal do
  #let(:instance) { Yookassa::PayoutDeal.new }

  describe 'test an instance of PayoutDeal' do
    it 'should create an instance of PayoutDeal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDeal)
    end
  end
