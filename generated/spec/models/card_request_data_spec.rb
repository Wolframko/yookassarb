...
# Unit tests for Yookassa::CardRequestData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::CardRequestData do
  #let(:instance) { Yookassa::CardRequestData.new }

  describe 'test an instance of CardRequestData' do
    it 'should create an instance of CardRequestData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::CardRequestData)
    end
  end
