...
# Unit tests for Yookassa::ReceiptData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptData do
  #let(:instance) { Yookassa::ReceiptData.new }

  describe 'test an instance of ReceiptData' do
    it 'should create an instance of ReceiptData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptData)
    end
  end
