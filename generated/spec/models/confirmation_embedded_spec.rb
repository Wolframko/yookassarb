...
# Unit tests for Yookassa::ConfirmationEmbedded
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationEmbedded do
  #let(:instance) { Yookassa::ConfirmationEmbedded.new }

  describe 'test an instance of ConfirmationEmbedded' do
    it 'should create an instance of ConfirmationEmbedded' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationEmbedded)
    end
  end
