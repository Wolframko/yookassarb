...
# Unit tests for Yookassa::PayoutCancellationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutCancellationDetails do
  #let(:instance) { Yookassa::PayoutCancellationDetails.new }

  describe 'test an instance of PayoutCancellationDetails' do
    it 'should create an instance of PayoutCancellationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutCancellationDetails)
    end
  end
  ...
  describe 'test attribute "party"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yoo_money", "payout_network"])
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["insufficient_funds", "fraud_suspected", "one_time_limit_exceeded", "periodic_limit_exceeded", "rejected_by_payee", "general_decline", "issuer_unavailable", "recipient_not_found", "recipient_check_failed", "identification_required", "self_employed_annual_limit_exceeded"])
      # validator.allowable_values.each do |value|
