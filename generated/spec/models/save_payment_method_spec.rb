...
# Unit tests for Yookassa::SavePaymentMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethod do
  #let(:instance) { Yookassa::SavePaymentMethod.new }

  describe 'test an instance of SavePaymentMethod' do
    it 'should create an instance of SavePaymentMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethod)
    end
  end
