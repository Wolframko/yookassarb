...
# Unit tests for Yookassa::RefundSourcesDataPlatformFeeAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundSourcesDataPlatformFeeAmount do
  #let(:instance) { Yookassa::RefundSourcesDataPlatformFeeAmount.new }

  describe 'test an instance of RefundSourcesDataPlatformFeeAmount' do
    it 'should create an instance of RefundSourcesDataPlatformFeeAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundSourcesDataPlatformFeeAmount)
    end
  end
