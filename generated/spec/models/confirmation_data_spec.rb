...
# Unit tests for Yookassa::ConfirmationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationData do
  #let(:instance) { Yookassa::ConfirmationData.new }

  describe 'test an instance of ConfirmationData' do
    it 'should create an instance of ConfirmationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationData)
    end
  end
