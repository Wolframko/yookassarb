...
# Unit tests for Yookassa::SettlementPayoutRefund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SettlementPayoutRefund do
  #let(:instance) { Yookassa::SettlementPayoutRefund.new }

  describe 'test an instance of SettlementPayoutRefund' do
    it 'should create an instance of SettlementPayoutRefund' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SettlementPayoutRefund)
    end
  end
