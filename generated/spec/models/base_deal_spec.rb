...
# Unit tests for Yookassa::BaseDeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BaseDeal do
  #let(:instance) { Yookassa::BaseDeal.new }

  describe 'test an instance of BaseDeal' do
    it 'should create an instance of BaseDeal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BaseDeal)
    end
  end
