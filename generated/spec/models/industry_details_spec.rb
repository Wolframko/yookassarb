...
# Unit tests for Yookassa::IndustryDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::IndustryDetails do
  #let(:instance) { Yookassa::IndustryDetails.new }

  describe 'test an instance of IndustryDetails' do
    it 'should create an instance of IndustryDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::IndustryDetails)
    end
  end
