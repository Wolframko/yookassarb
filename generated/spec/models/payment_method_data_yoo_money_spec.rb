...
# Unit tests for Yookassa::PaymentMethodDataYooMoney
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataYooMoney do
  #let(:instance) { Yookassa::PaymentMethodDataYooMoney.new }

  describe 'test an instance of PaymentMethodDataYooMoney' do
    it 'should create an instance of PaymentMethodDataYooMoney' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataYooMoney)
    end
  end
