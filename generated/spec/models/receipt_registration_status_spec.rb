...
# Unit tests for Yookassa::ReceiptRegistrationStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptRegistrationStatus do
  #let(:instance) { Yookassa::ReceiptRegistrationStatus.new }

  describe 'test an instance of ReceiptRegistrationStatus' do
    it 'should create an instance of ReceiptRegistrationStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptRegistrationStatus)
    end
  end
