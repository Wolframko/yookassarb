...
# Unit tests for Yookassa::RefundSourcesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundSourcesData do
  #let(:instance) { Yookassa::RefundSourcesData.new }

  describe 'test an instance of RefundSourcesData' do
    it 'should create an instance of RefundSourcesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundSourcesData)
    end
  end
