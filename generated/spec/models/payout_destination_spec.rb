...
# Unit tests for Yookassa::PayoutDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDestination do
  #let(:instance) { Yookassa::PayoutDestination.new }

  describe 'test an instance of PayoutDestination' do
    it 'should create an instance of PayoutDestination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDestination)
    end
  end
