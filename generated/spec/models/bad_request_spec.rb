...
# Unit tests for Yookassa::BadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BadRequest do
  #let(:instance) { Yookassa::BadRequest.new }

  describe 'test an instance of BadRequest' do
    it 'should create an instance of BadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BadRequest)
    end
  end
