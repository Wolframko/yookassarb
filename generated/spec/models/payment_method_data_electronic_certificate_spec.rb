...
# Unit tests for Yookassa::PaymentMethodDataElectronicCertificate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataElectronicCertificate do
  #let(:instance) { Yookassa::PaymentMethodDataElectronicCertificate.new }

  describe 'test an instance of PaymentMethodDataElectronicCertificate' do
    it 'should create an instance of PaymentMethodDataElectronicCertificate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataElectronicCertificate)
    end
  end
  ...
  describe 'test attribute "electronic_certificate"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
