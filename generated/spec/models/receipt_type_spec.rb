...
# Unit tests for Yookassa::ReceiptType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptType do
  #let(:instance) { Yookassa::ReceiptType.new }

  describe 'test an instance of ReceiptType' do
    it 'should create an instance of ReceiptType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptType)
    end
  end
