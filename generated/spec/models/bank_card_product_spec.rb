...
# Unit tests for Yookassa::BankCardProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BankCardProduct do
  #let(:instance) { Yookassa::BankCardProduct.new }

  describe 'test an instance of BankCardProduct' do
    it 'should create an instance of BankCardProduct' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BankCardProduct)
    end
  end
