...
# Unit tests for Yookassa::PaymentOrderRecipientUtilities
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOrderRecipientUtilities do
  #let(:instance) { Yookassa::PaymentOrderRecipientUtilities.new }

  describe 'test an instance of PaymentOrderRecipientUtilities' do
    it 'should create an instance of PaymentOrderRecipientUtilities' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOrderRecipientUtilities)
    end
  end
