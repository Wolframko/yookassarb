...
# Unit tests for Yookassa::SafeDealRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SafeDealRequest do
  #let(:instance) { Yookassa::SafeDealRequest.new }

  describe 'test an instance of SafeDealRequest' do
    it 'should create an instance of SafeDealRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SafeDealRequest)
    end
  end
  ...
  describe 'test attribute "fee_moment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
