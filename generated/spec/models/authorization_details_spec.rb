...
# Unit tests for Yookassa::AuthorizationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::AuthorizationDetails do
  #let(:instance) { Yookassa::AuthorizationDetails.new }

  describe 'test an instance of AuthorizationDetails' do
    it 'should create an instance of AuthorizationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::AuthorizationDetails)
    end
  end
