...
# Unit tests for Yookassa::RefundStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundStatus do
  #let(:instance) { Yookassa::RefundStatus.new }

  describe 'test an instance of RefundStatus' do
    it 'should create an instance of RefundStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundStatus)
    end
  end
