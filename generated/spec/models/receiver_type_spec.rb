...
# Unit tests for Yookassa::ReceiverType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiverType do
  #let(:instance) { Yookassa::ReceiverType.new }

  describe 'test an instance of ReceiverType' do
    it 'should create an instance of ReceiverType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiverType)
    end
  end
