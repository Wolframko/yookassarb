...
# Unit tests for Yookassa::PaymentOverviewStatementData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentOverviewStatementData do
  #let(:instance) { Yookassa::PaymentOverviewStatementData.new }

  describe 'test an instance of PaymentOverviewStatementData' do
    it 'should create an instance of PaymentOverviewStatementData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentOverviewStatementData)
    end
  end
