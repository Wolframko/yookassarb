...
# Unit tests for Yookassa::NotificationEventType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::NotificationEventType do
  #let(:instance) { Yookassa::NotificationEventType.new }

  describe 'test an instance of NotificationEventType' do
    it 'should create an instance of NotificationEventType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::NotificationEventType)
    end
  end
