...
# Unit tests for Yookassa::PaymentMethodDataSberBnpl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataSberBnpl do
  #let(:instance) { Yookassa::PaymentMethodDataSberBnpl.new }

  describe 'test an instance of PaymentMethodDataSberBnpl' do
    it 'should create an instance of PaymentMethodDataSberBnpl' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataSberBnpl)
    end
  end
