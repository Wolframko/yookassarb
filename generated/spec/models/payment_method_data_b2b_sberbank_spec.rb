...
# Unit tests for Yookassa::PaymentMethodDataB2bSberbank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataB2bSberbank do
  #let(:instance) { Yookassa::PaymentMethodDataB2bSberbank.new }

  describe 'test an instance of PaymentMethodDataB2bSberbank' do
    it 'should create an instance of PaymentMethodDataB2bSberbank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataB2bSberbank)
    end
  end
