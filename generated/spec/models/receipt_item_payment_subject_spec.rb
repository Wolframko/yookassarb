...
# Unit tests for Yookassa::ReceiptItemPaymentSubject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemPaymentSubject do
  #let(:instance) { Yookassa::ReceiptItemPaymentSubject.new }

  describe 'test an instance of ReceiptItemPaymentSubject' do
    it 'should create an instance of ReceiptItemPaymentSubject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemPaymentSubject)
    end
  end
