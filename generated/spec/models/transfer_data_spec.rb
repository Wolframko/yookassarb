...
# Unit tests for Yookassa::TransferData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::TransferData do
  #let(:instance) { Yookassa::TransferData.new }

  describe 'test an instance of TransferData' do
    it 'should create an instance of TransferData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::TransferData)
    end
  end
