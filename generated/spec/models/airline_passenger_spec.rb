...
# Unit tests for Yookassa::AirlinePassenger
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::AirlinePassenger do
  #let(:instance) { Yookassa::AirlinePassenger.new }

  describe 'test an instance of AirlinePassenger' do
    it 'should create an instance of AirlinePassenger' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::AirlinePassenger)
    end
  end
