...
# Unit tests for Yookassa::PersonalDataCancellationDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PersonalDataCancellationDetails do
  #let(:instance) { Yookassa::PersonalDataCancellationDetails.new }

  describe 'test an instance of PersonalDataCancellationDetails' do
    it 'should create an instance of PersonalDataCancellationDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PersonalDataCancellationDetails)
    end
  end
  ...
  describe 'test attribute "party"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["yoo_money"])
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["expired_by_timeout"])
      # validator.allowable_values.each do |value|
