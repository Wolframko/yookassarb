...
# Unit tests for Yookassa::DealList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DealList do
  #let(:instance) { Yookassa::DealList.new }

  describe 'test an instance of DealList' do
    it 'should create an instance of DealList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DealList)
    end
  end
