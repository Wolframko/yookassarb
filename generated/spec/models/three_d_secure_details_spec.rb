...
# Unit tests for Yookassa::ThreeDSecureDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ThreeDSecureDetails do
  #let(:instance) { Yookassa::ThreeDSecureDetails.new }

  describe 'test an instance of ThreeDSecureDetails' do
    it 'should create an instance of ThreeDSecureDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ThreeDSecureDetails)
    end
  end
