...
# Unit tests for Yookassa::ElectronicCertificateRefundDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateRefundDataRequest do
  #let(:instance) { Yookassa::ElectronicCertificateRefundDataRequest.new }

  describe 'test an instance of ElectronicCertificateRefundDataRequest' do
    it 'should create an instance of ElectronicCertificateRefundDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateRefundDataRequest)
    end
  end
