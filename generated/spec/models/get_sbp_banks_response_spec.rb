...
# Unit tests for Yookassa::GetSbpBanksResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::GetSbpBanksResponse do
  #let(:instance) { Yookassa::GetSbpBanksResponse.new }

  describe 'test an instance of GetSbpBanksResponse' do
    it 'should create an instance of GetSbpBanksResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::GetSbpBanksResponse)
    end
  end
