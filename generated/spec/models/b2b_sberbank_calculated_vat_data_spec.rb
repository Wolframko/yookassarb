...
# Unit tests for Yookassa::B2bSberbankCalculatedVatData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::B2bSberbankCalculatedVatData do
  #let(:instance) { Yookassa::B2bSberbankCalculatedVatData.new }

  describe 'test an instance of B2bSberbankCalculatedVatData' do
    it 'should create an instance of B2bSberbankCalculatedVatData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::B2bSberbankCalculatedVatData)
    end
  end
  ...
  describe 'test attribute "rate"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["5", "7", "10", "20", "22"])
      # validator.allowable_values.each do |value|
      #   expect { instance.rate = value }.not_to raise_error
      # end
    end
  end
