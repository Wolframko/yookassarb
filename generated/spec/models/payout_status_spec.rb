...
# Unit tests for Yookassa::PayoutStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutStatus do
  #let(:instance) { Yookassa::PayoutStatus.new }

  describe 'test an instance of PayoutStatus' do
    it 'should create an instance of PayoutStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutStatus)
    end
  end
