...
# Unit tests for Yookassa::IncomeReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::IncomeReceipt do
  #let(:instance) { Yookassa::IncomeReceipt.new }

  describe 'test an instance of IncomeReceipt' do
    it 'should create an instance of IncomeReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::IncomeReceipt)
    end
  end
  ...
  describe 'test attribute "npd_receipt_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
