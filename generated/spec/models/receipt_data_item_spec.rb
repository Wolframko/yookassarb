...
# Unit tests for Yookassa::ReceiptDataItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptDataItem do
  #let(:instance) { Yookassa::ReceiptDataItem.new }

  describe 'test an instance of ReceiptDataItem' do
    it 'should create an instance of ReceiptDataItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptDataItem)
    end
  end
