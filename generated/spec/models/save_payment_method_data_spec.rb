...
# Unit tests for Yookassa::SavePaymentMethodData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SavePaymentMethodData do
  #let(:instance) { Yookassa::SavePaymentMethodData.new }

  describe 'test an instance of SavePaymentMethodData' do
    it 'should create an instance of SavePaymentMethodData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SavePaymentMethodData)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bank_card"])
