...
# Unit tests for Yookassa::RefundDealData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundDealData do
  #let(:instance) { Yookassa::RefundDealData.new }

  describe 'test an instance of RefundDealData' do
    it 'should create an instance of RefundDealData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundDealData)
    end
  end

  describe 'test attribute "refund_settlements"' do
    it 'should work' do
