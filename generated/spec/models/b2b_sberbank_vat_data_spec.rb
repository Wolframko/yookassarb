...
# Unit tests for Yookassa::B2bSberbankVatData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::B2bSberbankVatData do
  #let(:instance) { Yookassa::B2bSberbankVatData.new }

  describe 'test an instance of B2bSberbankVatData' do
    it 'should create an instance of B2bSberbankVatData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::B2bSberbankVatData)
    end
  end
