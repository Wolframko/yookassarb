...
# Unit tests for Yookassa::PaymentDealInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentDealInfo do
  #let(:instance) { Yookassa::PaymentDealInfo.new }

  describe 'test an instance of PaymentDealInfo' do
    it 'should create an instance of PaymentDealInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentDealInfo)
    end
  end
