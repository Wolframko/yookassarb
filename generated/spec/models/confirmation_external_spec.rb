...
# Unit tests for Yookassa::ConfirmationExternal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ConfirmationExternal do
  #let(:instance) { Yookassa::ConfirmationExternal.new }

  describe 'test an instance of ConfirmationExternal' do
    it 'should create an instance of ConfirmationExternal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ConfirmationExternal)
    end
  end
