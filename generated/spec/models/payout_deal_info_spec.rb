...
# Unit tests for Yookassa::PayoutDealInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDealInfo do
  #let(:instance) { Yookassa::PayoutDealInfo.new }

  describe 'test an instance of PayoutDealInfo' do
    it 'should create an instance of PayoutDealInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDealInfo)
    end
  end
