...
# Unit tests for Yookassa::ReceiptItemMeasure
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItemMeasure do
  #let(:instance) { Yookassa::ReceiptItemMeasure.new }

  describe 'test an instance of ReceiptItemMeasure' do
    it 'should create an instance of ReceiptItemMeasure' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItemMeasure)
    end
  end
