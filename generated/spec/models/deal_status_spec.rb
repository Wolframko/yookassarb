...
# Unit tests for Yookassa::DealStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DealStatus do
  #let(:instance) { Yookassa::DealStatus.new }

  describe 'test an instance of DealStatus' do
    it 'should create an instance of DealStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DealStatus)
    end
  end
