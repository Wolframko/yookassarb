...
# Unit tests for Yookassa::PayoutSelfEmployed
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutSelfEmployed do
  #let(:instance) { Yookassa::PayoutSelfEmployed.new }

  describe 'test an instance of PayoutSelfEmployed' do
    it 'should create an instance of PayoutSelfEmployed' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutSelfEmployed)
    end
  end
