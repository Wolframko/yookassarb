...
# Unit tests for Yookassa::PayoutStatementRecipientPersonalDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutStatementRecipientPersonalDataRequest do
  #let(:instance) { Yookassa::PayoutStatementRecipientPersonalDataRequest.new }

  describe 'test an instance of PayoutStatementRecipientPersonalDataRequest' do
    it 'should create an instance of PayoutStatementRecipientPersonalDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutStatementRecipientPersonalDataRequest)
    end
  end
