...
# Unit tests for Yookassa::SbpParticipantBank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SbpParticipantBank do
  #let(:instance) { Yookassa::SbpParticipantBank.new }

  describe 'test an instance of SbpParticipantBank' do
    it 'should create an instance of SbpParticipantBank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SbpParticipantBank)
    end
  end
