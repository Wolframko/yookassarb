...
# Unit tests for Yookassa::PayoutToCardDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToCardDestination do
  #let(:instance) { Yookassa::PayoutToCardDestination.new }

  describe 'test an instance of PayoutToCardDestination' do
    it 'should create an instance of PayoutToCardDestination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToCardDestination)
    end
  end
