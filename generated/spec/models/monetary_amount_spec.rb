...
# Unit tests for Yookassa::MonetaryAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::MonetaryAmount do
  #let(:instance) { Yookassa::MonetaryAmount.new }

  describe 'test an instance of MonetaryAmount' do
    it 'should create an instance of MonetaryAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::MonetaryAmount)
    end
  end
