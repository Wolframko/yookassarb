...
# Unit tests for Yookassa::PayoutToYooMoneyDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutToYooMoneyDestination do
  #let(:instance) { Yookassa::PayoutToYooMoneyDestination.new }

  describe 'test an instance of PayoutToYooMoneyDestination' do
    it 'should create an instance of PayoutToYooMoneyDestination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutToYooMoneyDestination)
    end
  end
