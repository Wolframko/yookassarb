...
# Unit tests for Yookassa::PaymentMethodDataSberLoan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataSberLoan do
  #let(:instance) { Yookassa::PaymentMethodDataSberLoan.new }

  describe 'test an instance of PaymentMethodDataSberLoan' do
    it 'should create an instance of PaymentMethodDataSberLoan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataSberLoan)
    end
  end
