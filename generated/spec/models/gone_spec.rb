...
# Unit tests for Yookassa::Gone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Gone do
  #let(:instance) { Yookassa::Gone.new }

  describe 'test an instance of Gone' do
    it 'should create an instance of Gone' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Gone)
    end
  end
  ...
  describe 'test attribute "code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["gone"])
      # validator.allowable_values.each do |value|
