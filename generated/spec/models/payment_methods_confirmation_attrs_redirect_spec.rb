...
# Unit tests for Yookassa::PaymentMethodsConfirmationAttrsRedirect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodsConfirmationAttrsRedirect do
  #let(:instance) { Yookassa::PaymentMethodsConfirmationAttrsRedirect.new }

  describe 'test an instance of PaymentMethodsConfirmationAttrsRedirect' do
    it 'should create an instance of PaymentMethodsConfirmationAttrsRedirect' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodsConfirmationAttrsRedirect)
    end
  end
