...
# Unit tests for Yookassa::PaymentMethodB2bSberbank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodB2bSberbank do
  #let(:instance) { Yookassa::PaymentMethodB2bSberbank.new }

  describe 'test an instance of PaymentMethodB2bSberbank' do
    it 'should create an instance of PaymentMethodB2bSberbank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodB2bSberbank)
    end
  end
  ...
  describe 'test attribute "vat_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "payer_bank_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
