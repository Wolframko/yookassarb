...
# Unit tests for Yookassa::PostReceiptData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PostReceiptData do
  #let(:instance) { Yookassa::PostReceiptData.new }

  describe 'test an instance of PostReceiptData' do
    it 'should create an instance of PostReceiptData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PostReceiptData)
    end
  end
  ...
  describe 'test attribute "additional_user_props"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
