...
# Unit tests for Yookassa::OperationalDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::OperationalDetails do
  #let(:instance) { Yookassa::OperationalDetails.new }

  describe 'test an instance of OperationalDetails' do
    it 'should create an instance of OperationalDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::OperationalDetails)
    end
  end
