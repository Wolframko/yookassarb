...
# Unit tests for Yookassa::BankCardDataSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::BankCardDataSource do
  #let(:instance) { Yookassa::BankCardDataSource.new }

  describe 'test an instance of BankCardDataSource' do
    it 'should create an instance of BankCardDataSource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::BankCardDataSource)
    end
  end
