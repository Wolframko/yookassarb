...
# Unit tests for Yookassa::SettlementItemType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SettlementItemType do
  #let(:instance) { Yookassa::SettlementItemType.new }

  describe 'test an instance of SettlementItemType' do
    it 'should create an instance of SettlementItemType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SettlementItemType)
    end
  end
