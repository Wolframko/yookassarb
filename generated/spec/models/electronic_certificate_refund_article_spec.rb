...
# Unit tests for Yookassa::ElectronicCertificateRefundArticle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ElectronicCertificateRefundArticle do
  #let(:instance) { Yookassa::ElectronicCertificateRefundArticle.new }

  describe 'test an instance of ElectronicCertificateRefundArticle' do
    it 'should create an instance of ElectronicCertificateRefundArticle' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ElectronicCertificateRefundArticle)
    end
  end
  ...
  describe 'test attribute "payment_article_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
