...
# Unit tests for Yookassa::B2bSberbankVatDataType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::B2bSberbankVatDataType do
  #let(:instance) { Yookassa::B2bSberbankVatDataType.new }

  describe 'test an instance of B2bSberbankVatDataType' do
    it 'should create an instance of B2bSberbankVatDataType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::B2bSberbankVatDataType)
    end
  end
