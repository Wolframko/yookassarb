...
# Unit tests for Yookassa::PaymentMethodBankCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodBankCard do
  #let(:instance) { Yookassa::PaymentMethodBankCard.new }

  describe 'test an instance of PaymentMethodBankCard' do
    it 'should create an instance of PaymentMethodBankCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodBankCard)
    end
  end
