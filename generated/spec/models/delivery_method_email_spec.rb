...
# Unit tests for Yookassa::DeliveryMethodEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::DeliveryMethodEmail do
  #let(:instance) { Yookassa::DeliveryMethodEmail.new }

  describe 'test an instance of DeliveryMethodEmail' do
    it 'should create an instance of DeliveryMethodEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::DeliveryMethodEmail)
    end
  end
