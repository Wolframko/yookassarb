...
# Unit tests for Yookassa::SettlementPaymentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SettlementPaymentItem do
  #let(:instance) { Yookassa::SettlementPaymentItem.new }

  describe 'test an instance of SettlementPaymentItem' do
    it 'should create an instance of SettlementPaymentItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SettlementPaymentItem)
    end
  end
