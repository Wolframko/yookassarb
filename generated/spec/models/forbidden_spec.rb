...
# Unit tests for Yookassa::Forbidden
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::Forbidden do
  #let(:instance) { Yookassa::Forbidden.new }

  describe 'test an instance of Forbidden' do
    it 'should create an instance of Forbidden' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::Forbidden)
    end
  end
  ...
  describe 'test attribute "code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["forbidden"])
      # validator.allowable_values.each do |value|
