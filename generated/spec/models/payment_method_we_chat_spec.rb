...
# Unit tests for Yookassa::PaymentMethodWeChat
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodWeChat do
  #let(:instance) { Yookassa::PaymentMethodWeChat.new }

  describe 'test an instance of PaymentMethodWeChat' do
    it 'should create an instance of PaymentMethodWeChat' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodWeChat)
    end
  end
