...
# Unit tests for Yookassa::PayoutSelfEmployedInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutSelfEmployedInfo do
  #let(:instance) { Yookassa::PayoutSelfEmployedInfo.new }

  describe 'test an instance of PayoutSelfEmployedInfo' do
    it 'should create an instance of PayoutSelfEmployedInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutSelfEmployedInfo)
    end
  end
