...
# Unit tests for Yookassa::ReceiptItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::ReceiptItem do
  #let(:instance) { Yookassa::ReceiptItem.new }

  describe 'test an instance of ReceiptItem' do
    it 'should create an instance of ReceiptItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::ReceiptItem)
    end
  end
