...
# Unit tests for Yookassa::B2bSberbankUntaxedVatData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::B2bSberbankUntaxedVatData do
  #let(:instance) { Yookassa::B2bSberbankUntaxedVatData.new }

  describe 'test an instance of B2bSberbankUntaxedVatData' do
    it 'should create an instance of B2bSberbankUntaxedVatData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::B2bSberbankUntaxedVatData)
    end
  end
