...
# Unit tests for Yookassa::SettlementPayoutPayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::SettlementPayoutPayment do
  #let(:instance) { Yookassa::SettlementPayoutPayment.new }

  describe 'test an instance of SettlementPayoutPayment' do
    it 'should create an instance of SettlementPayoutPayment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::SettlementPayoutPayment)
    end
  end
