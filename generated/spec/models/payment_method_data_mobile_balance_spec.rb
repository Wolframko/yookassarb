...
# Unit tests for Yookassa::PaymentMethodDataMobileBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodDataMobileBalance do
  #let(:instance) { Yookassa::PaymentMethodDataMobileBalance.new }

  describe 'test an instance of PaymentMethodDataMobileBalance' do
    it 'should create an instance of PaymentMethodDataMobileBalance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodDataMobileBalance)
    end
  end
