...
# Unit tests for Yookassa::PaymentMethodAlfabank
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodAlfabank do
  #let(:instance) { Yookassa::PaymentMethodAlfabank.new }

  describe 'test an instance of PaymentMethodAlfabank' do
    it 'should create an instance of PaymentMethodAlfabank' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodAlfabank)
    end
  end
