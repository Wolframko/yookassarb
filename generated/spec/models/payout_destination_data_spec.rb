...
# Unit tests for Yookassa::PayoutDestinationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PayoutDestinationData do
  #let(:instance) { Yookassa::PayoutDestinationData.new }

  describe 'test an instance of PayoutDestinationData' do
    it 'should create an instance of PayoutDestinationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PayoutDestinationData)
    end
  end
