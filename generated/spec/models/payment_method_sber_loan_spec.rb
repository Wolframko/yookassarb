...
# Unit tests for Yookassa::PaymentMethodSberLoan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::PaymentMethodSberLoan do
  #let(:instance) { Yookassa::PaymentMethodSberLoan.new }

  describe 'test an instance of PaymentMethodSberLoan' do
    it 'should create an instance of PaymentMethodSberLoan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::PaymentMethodSberLoan)
    end
  end

  describe 'test attribute "loan_option"' do
    it 'should work' do
  ...
  describe 'test attribute "suspended_until"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
