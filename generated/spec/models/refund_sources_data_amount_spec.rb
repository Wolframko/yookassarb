...
# Unit tests for Yookassa::RefundSourcesDataAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yookassa::RefundSourcesDataAmount do
  #let(:instance) { Yookassa::RefundSourcesDataAmount.new }

  describe 'test an instance of RefundSourcesDataAmount' do
    it 'should create an instance of RefundSourcesDataAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Yookassa::RefundSourcesDataAmount)
    end
  end
