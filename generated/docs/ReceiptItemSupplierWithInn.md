# Yookassa::ReceiptItemSupplierWithInn
...
| **inn** | **String** | ИНН поставщика в маскированном виде (тег в 54 ФЗ — 1226). Пример: ***. Параметр предусмотрен форматом фискальных документов (ФФД) и является обязательным, начиная с версии 1.05. | [optional] |
...
instance = Yookassa::ReceiptItemSupplierWithInn.new(
  name: null,
  phone: 79000000000,
  inn: 6321341814
)
