...
module Yookassa
  class FeeMoment
    PAYMENT_SUCCEEDED = "payment_succeeded".freeze
    DEAL_CLOSED = "deal_closed".freeze

    def self.all_vars
      @all_vars ||= [PAYMENT_SUCCEEDED, DEAL_CLOSED].freeze
    end
    ...
    def build_from_hash(value)
      return value if FeeMoment.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FeeMoment"
    end
  end
end
