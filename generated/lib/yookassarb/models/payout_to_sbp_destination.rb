...
module Yookassa
  ...
  class PayoutToSbpDestination < PayoutDestination
    ...
    def self.attribute_map
      {
        :'phone' => :'phone',
        :'bank_id' => :'bank_id',
        :'recipient_checked' => :'recipient_checked'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PayoutToSbpDestination` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PayoutToSbpDestination`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'recipient_checked')
        self.recipient_checked = attributes[:'recipient_checked']
      else
        self.recipient_checked = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @recipient_checked.nil?
        invalid_properties.push('invalid value for "recipient_checked", recipient_checked cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @phone !~ Regexp.new(/[0-9]{4,15}/)
      return false if @bank_id.nil?
      return false if @bank_id.to_s.length > 12
      return false if @recipient_checked.nil?
      true && super
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] recipient_checked Value to be assigned
    def recipient_checked=(recipient_checked)
      if recipient_checked.nil?
        fail ArgumentError, 'recipient_checked cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          phone == o.phone &&
          bank_id == o.bank_id &&
          recipient_checked == o.recipient_checked && super(o)
    end
    ...
    def hash
      [phone, bank_id, recipient_checked].hash
    end
