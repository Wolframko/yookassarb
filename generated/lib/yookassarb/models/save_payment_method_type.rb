...
module Yookassa
  class SavePaymentMethodType
    BANK_CARD = "bank_card".freeze

    def self.all_vars
      @all_vars ||= [BANK_CARD].freeze
    end
    ...
    def build_from_hash(value)
      return value if SavePaymentMethodType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SavePaymentMethodType"
    end
  end
end
