...
module Yookassa
  class BankCardDataSource
    ...
    MIR_PAY = "mir_pay".freeze

    def self.all_vars
      @all_vars ||= [APPLE_PAY, GOOGLE_PAY, MIR_PAY].freeze
    end
    ...
    def build_from_hash(value)
      return value if BankCardDataSource.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #BankCardDataSource"
    end
  end
end
