...
module Yookassa
  class BankCardType
    ...
    VISA = "Visa".freeze
    MIR = "Mir".freeze
    UNION_PAY = "UnionPay".freeze
    JCB = "JCB".freeze
    AMERICAN_EXPRESS = "AmericanExpress".freeze
    DINERS_CLUB = "DinersClub".freeze
    DISCOVER_CARD = "DiscoverCard".freeze
    INSTA_PAYMENT = "InstaPayment".freeze
    INSTA_PAYMENT_TM = "InstaPaymentTM".freeze
    LASER = "Laser".freeze
    ...
    def self.all_vars
      @all_vars ||= [MASTER_CARD, VISA, MIR, UNION_PAY, JCB, AMERICAN_EXPRESS, DINERS_CLUB, DISCOVER_CARD, INSTA_PAYMENT, INSTA_PAYMENT_TM, LASER, DANKORT, SOLO, SWITCH, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if BankCardType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #BankCardType"
    end
  end
end
