...
module Yookassa
  class PaymentMethodsConfirmationType
    REDIRECT = "redirect".freeze

    def self.all_vars
      @all_vars ||= [REDIRECT].freeze
    end
    ...
    def build_from_hash(value)
      return value if PaymentMethodsConfirmationType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentMethodsConfirmationType"
    end
  end
end
