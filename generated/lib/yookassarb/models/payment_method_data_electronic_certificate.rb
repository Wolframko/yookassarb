...
module Yookassa
  ...
  class PaymentMethodDataElectronicCertificate < PaymentMethodData
    attr_accessor :card

    attr_accessor :electronic_certificate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PaymentMethodDataElectronicCertificate` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PaymentMethodDataElectronicCertificate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'electronic_certificate')
        self.electronic_certificate = attributes[:'electronic_certificate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          card == o.card &&
          electronic_certificate == o.electronic_certificate &&
          articles == o.articles && super(o)
    end
    ...
    def hash
      [card, electronic_certificate, articles].hash
    end
