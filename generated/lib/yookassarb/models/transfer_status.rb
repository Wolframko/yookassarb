...
module Yookassa
  class TransferStatus
    ...
    WAITING_FOR_CAPTURE = "waiting_for_capture".freeze
    SUCCEEDED = "succeeded".freeze
    CANCELED = "canceled".freeze

    def self.all_vars
      @all_vars ||= [PENDING, WAITING_FOR_CAPTURE, SUCCEEDED, CANCELED].freeze
    end
    ...
    def build_from_hash(value)
      return value if TransferStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TransferStatus"
    end
  end
end
