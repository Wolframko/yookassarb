...
module Yookassa
  class ConfirmationDataType
    REDIRECT = "redirect".freeze
    EXTERNAL = "external".freeze
    QR = "qr".freeze
    EMBEDDED = "embedded".freeze
    MOBILE_APPLICATION = "mobile_application".freeze

    def self.all_vars
      @all_vars ||= [REDIRECT, EXTERNAL, QR, EMBEDDED, MOBILE_APPLICATION].freeze
    end
    ...
    def build_from_hash(value)
      return value if ConfirmationDataType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ConfirmationDataType"
    end
  end
end
