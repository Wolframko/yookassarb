...
module Yookassa
  class CardRequestDataWithCsc < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::CardRequestDataWithCsc` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::CardRequestDataWithCsc`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@csc.nil? && @csc !~ pattern
        invalid_properties.push("invalid value for \"csc\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@csc.nil? && @csc !~ Regexp.new(/[0-9]{3,4}/)
      true
    end
    ...
    def csc=(csc)
      ...
      pattern = Regexp.new(/[0-9]{3,4}/)
      if csc !~ pattern
        fail ArgumentError, "invalid value for \"csc\", must conform to the pattern #{pattern}."
      end
    ...
    def hash
      [number, expiry_year, expiry_month, cardholder, csc].hash
    end
