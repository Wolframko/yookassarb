...
module Yookassa
  ...
  class OperationalDetails < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::OperationalDetails` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::OperationalDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @operation_id > 255
        invalid_properties.push('invalid value for "operation_id", must be smaller than or equal to 255.')
      end

      if @operation_id < 0
        invalid_properties.push('invalid value for "operation_id", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @operation_id > 255
      return false if @operation_id < 0
    ...
    def operation_id=(operation_id)
      ...
      if operation_id > 255
        fail ArgumentError, 'invalid value for "operation_id", must be smaller than or equal to 255.'
      end

      if operation_id < 0
        fail ArgumentError, 'invalid value for "operation_id", must be greater than or equal to 0.'
      end
    ...
    def hash
      [operation_id, value, created_at].hash
    end
