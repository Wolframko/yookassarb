...
module Yookassa
  class PersonalDataType
    PAYOUT_STATEMENT_RECIPIENT = "payout_statement_recipient".freeze
    SBP_PAYOUT_RECIPIENT = "sbp_payout_recipient".freeze

    def self.all_vars
      @all_vars ||= [PAYOUT_STATEMENT_RECIPIENT, SBP_PAYOUT_RECIPIENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if PersonalDataType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PersonalDataType"
    end
  end
end
