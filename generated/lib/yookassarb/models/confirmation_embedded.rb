  ...
  class ConfirmationEmbedded < Confirmation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::ConfirmationEmbedded` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::ConfirmationEmbedded`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confirmation_token')
        self.confirmation_token = attributes[:'confirmation_token']
      else
    ...
    def list_invalid_properties
      ...
      if @confirmation_token.nil?
        invalid_properties.push('invalid value for "confirmation_token", confirmation_token cannot be nil.')
      end
    ...
    # @param [Object] confirmation_token Value to be assigned
    def confirmation_token=(confirmation_token)
      if confirmation_token.nil?
        fail ArgumentError, 'confirmation_token cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          confirmation_token == o.confirmation_token && super(o)
    end
