...
module Yookassa
  class PaymentOverviewStatementDeliveryMethodType
    EMAIL = "email".freeze

    def self.all_vars
      @all_vars ||= [EMAIL].freeze
    end
    ...
    def build_from_hash(value)
      return value if PaymentOverviewStatementDeliveryMethodType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentOverviewStatementDeliveryMethodType"
    end
  end
end
