...
module Yookassa
  ...
  class RefundDealInfo < ApiModelBase
    ...
    def self.attribute_map
      {
        :'id' => :'id',
        :'refund_settlements' => :'refund_settlements'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::RefundDealInfo` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::RefundDealInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'refund_settlements')
        if (value = attributes[:'refund_settlements']).is_a?(Array)
          self.refund_settlements = value
        end
      else
        self.refund_settlements = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @refund_settlements.nil?
        invalid_properties.push('invalid value for "refund_settlements", refund_settlements cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @refund_settlements.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] refund_settlements Value to be assigned
    def refund_settlements=(refund_settlements)
      if refund_settlements.nil?
        fail ArgumentError, 'refund_settlements cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          refund_settlements == o.refund_settlements
    end
