...
module Yookassa
  ...
  class Refund < ApiModelBase
    ...
    attr_accessor :refund_authorization_details
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::Refund` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::Refund`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'refund_method')
        self.refund_method = attributes[:'refund_method']
      end

      if attributes.key?(:'refund_authorization_details')
        self.refund_authorization_details = attributes[:'refund_authorization_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          refund_authorization_details == o.refund_authorization_details &&
          metadata == o.metadata
    end
    ...
    def hash
      [id, payment_id, status, cancellation_details, receipt_registration, created_at, amount, description, sources, deal, refund_method, refund_authorization_details, metadata].hash
    end
