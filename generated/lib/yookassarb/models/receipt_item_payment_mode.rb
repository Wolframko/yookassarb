...
module Yookassa
  class ReceiptItemPaymentMode
    FULL_PREPAYMENT = "full_prepayment".freeze
    PARTIAL_PREPAYMENT = "partial_prepayment".freeze
    ADVANCE = "advance".freeze
    FULL_PAYMENT = "full_payment".freeze
    PARTIAL_PAYMENT = "partial_payment".freeze
    CREDIT = "credit".freeze
    CREDIT_PAYMENT = "credit_payment".freeze

    def self.all_vars
      @all_vars ||= [FULL_PREPAYMENT, PARTIAL_PREPAYMENT, ADVANCE, FULL_PAYMENT, PARTIAL_PAYMENT, CREDIT, CREDIT_PAYMENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReceiptItemPaymentMode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReceiptItemPaymentMode"
    end
  end
end
