...
module Yookassa
  class ReceiverType
    ...
    def self.all_vars
      @all_vars ||= [MOBILE_BALANCE, DIGITAL_WALLET, BANK_ACCOUNT].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReceiverType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReceiverType"
    end
  end
end
