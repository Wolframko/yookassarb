...
module Yookassa
  class ReceiptItemAgentType
    BANKING_PAYMENT_AGENT = "banking_payment_agent".freeze
    BANKING_PAYMENT_SUBAGENT = "banking_payment_subagent".freeze
    PAYMENT_AGENT = "payment_agent".freeze
    PAYMENT_SUBAGENT = "payment_subagent".freeze
    ATTORNEY = "attorney".freeze
    COMMISSIONER = "commissioner".freeze
    AGENT = "agent".freeze

    def self.all_vars
      @all_vars ||= [BANKING_PAYMENT_AGENT, BANKING_PAYMENT_SUBAGENT, PAYMENT_AGENT, PAYMENT_SUBAGENT, ATTORNEY, COMMISSIONER, AGENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReceiptItemAgentType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReceiptItemAgentType"
    end
  end
end
