...
module Yookassa
  class RefundMethodType
    SBP = "sbp".freeze
    ELECTRONIC_CERTIFICATE = "electronic_certificate".freeze

    def self.all_vars
      @all_vars ||= [SBP, ELECTRONIC_CERTIFICATE].freeze
    end
    ...
    def build_from_hash(value)
      return value if RefundMethodType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RefundMethodType"
    end
  end
end
