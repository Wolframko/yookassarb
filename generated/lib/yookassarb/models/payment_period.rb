...
module Yookassa
  ...
  class PaymentPeriod < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PaymentPeriod` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PaymentPeriod`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @year > 2050
        invalid_properties.push('invalid value for "year", must be smaller than or equal to 2050.')
      end

      if @year < 1920
        invalid_properties.push('invalid value for "year", must be greater than or equal to 1920.')
      end
    ...
    def valid?
      ...
      return false if @year > 2050
      return false if @year < 1920
      true
    end
    ...
    def year=(year)
      ...
      if year > 2050
        fail ArgumentError, 'invalid value for "year", must be smaller than or equal to 2050.'
      end

      if year < 1920
        fail ArgumentError, 'invalid value for "year", must be greater than or equal to 1920.'
      end
