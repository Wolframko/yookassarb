...
module Yookassa
  ...
  class PaymentOverviewStatementData < Statement
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PaymentOverviewStatementData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PaymentOverviewStatementData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] delivery_method Value to be assigned
    def delivery_method=(delivery_method)
      if delivery_method.nil?
        fail ArgumentError, 'delivery_method cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          delivery_method == o.delivery_method && super(o)
    end
