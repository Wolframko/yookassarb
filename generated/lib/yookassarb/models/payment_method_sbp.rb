...
module Yookassa
  ...
  class PaymentMethodSbp < PaymentMethod
    ...
    attr_accessor :sbp_operation_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PaymentMethodSbp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PaymentMethodSbp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sbp_operation_id')
        self.sbp_operation_id = attributes[:'sbp_operation_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sbp_operation_id == o.sbp_operation_id &&
    ...
    def hash
      [sbp_operation_id, payer_bank_details].hash
    end
