...
module Yookassa
  class B2bSberbankVatDataType
    CALCULATED = "calculated".freeze
    UNTAXED = "untaxed".freeze
    MIXED = "mixed".freeze

    def self.all_vars
      @all_vars ||= [CALCULATED, UNTAXED, MIXED].freeze
    end
    ...
    def build_from_hash(value)
      return value if B2bSberbankVatDataType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #B2bSberbankVatDataType"
    end
  end
end
