...
module Yookassa
  ...
  class PaymentMethodsConfirmationRedirect < PaymentMethodsConfirmation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::PaymentMethodsConfirmationRedirect` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::PaymentMethodsConfirmationRedirect`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confirmation_url')
    ...
    def list_invalid_properties
      ...
      if @confirmation_url.nil?
        invalid_properties.push('invalid value for "confirmation_url", confirmation_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @confirmation_url.nil?
      return false if !@return_url.nil? && @return_url.to_s.length > 2048
      true && super
    end

    # Custom attribute writer method with validation
    # @param [Object] confirmation_url Value to be assigned
    def confirmation_url=(confirmation_url)
      if confirmation_url.nil?
        fail ArgumentError, 'confirmation_url cannot be nil'
      end
    ...
    def return_url=(return_url)
      ...
      if return_url.to_s.length > 2048
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enforce == o.enforce &&
          return_url == o.return_url && super(o)
    end
    ...
    def hash
      [confirmation_url, enforce, return_url].hash
    end
