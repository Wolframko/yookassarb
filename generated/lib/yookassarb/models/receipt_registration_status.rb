...
module Yookassa
  class ReceiptRegistrationStatus
    ...
    def self.all_vars
      @all_vars ||= [PENDING, SUCCEEDED, CANCELED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReceiptRegistrationStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReceiptRegistrationStatus"
    end
  end
end
