...
module Yookassa
  class PayoutDestinationType
    ...
    def self.all_vars
      @all_vars ||= [BANK_CARD, YOO_MONEY, SBP].freeze
    end
    ...
    def build_from_hash(value)
      return value if PayoutDestinationType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PayoutDestinationType"
    end
  end
end
