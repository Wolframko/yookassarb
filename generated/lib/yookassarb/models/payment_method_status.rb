...
module Yookassa
  class PaymentMethodStatus
    ...
    def self.all_vars
      @all_vars ||= [PENDING, ACTIVE, INACTIVE].freeze
    end
    ...
    def build_from_hash(value)
      return value if PaymentMethodStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PaymentMethodStatus"
    end
  end
end
