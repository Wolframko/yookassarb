  ...
  class ConfirmationQr < Confirmation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::ConfirmationQr` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::ConfirmationQr`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confirmation_data')
        self.confirmation_data = attributes[:'confirmation_data']
      else
        self.confirmation_data = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @confirmation_data.nil?
        invalid_properties.push('invalid value for "confirmation_data", confirmation_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @confirmation_data.nil?
      true && super
    end

    # Custom attribute writer method with validation
    # @param [Object] confirmation_data Value to be assigned
    def confirmation_data=(confirmation_data)
      if confirmation_data.nil?
        fail ArgumentError, 'confirmation_data cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          confirmation_data == o.confirmation_data && super(o)
    end
