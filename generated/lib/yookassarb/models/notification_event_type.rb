...
module Yookassa
  class NotificationEventType
    PAYMENT_WAITING_FOR_CAPTURE = "payment.waiting_for_capture".freeze
    PAYMENT_SUCCEEDED = "payment.succeeded".freeze
    PAYMENT_CANCELED = "payment.canceled".freeze
    REFUND_SUCCEEDED = "refund.succeeded".freeze

    def self.all_vars
      @all_vars ||= [PAYMENT_WAITING_FOR_CAPTURE, PAYMENT_SUCCEEDED, PAYMENT_CANCELED, REFUND_SUCCEEDED].freeze
    end
    ...
    def build_from_hash(value)
      return value if NotificationEventType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #NotificationEventType"
    end
  end
end
