  ...
  class IncomeReceipt < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yookassa::IncomeReceipt` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yookassa::IncomeReceipt`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'npd_receipt_id')
        self.npd_receipt_id = attributes[:'npd_receipt_id']
      end
    ...
    def list_invalid_properties
      ...
      if @service_name.to_s.length > 50
        invalid_properties.push('invalid value for "service_name", the character length must be smaller than or equal to 50.')
      end

      if @service_name.to_s.length < 1
        invalid_properties.push('invalid value for "service_name", the character length must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @service_name.to_s.length > 50
    ...
    def service_name=(service_name)
      ...
      if service_name.to_s.length > 50
        fail ArgumentError, 'invalid value for "service_name", the character length must be smaller than or equal to 50.'
      end

      if service_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "service_name", the character length must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          npd_receipt_id == o.npd_receipt_id &&
          url == o.url &&
          amount == o.amount
    end
    ...
    def hash
      [service_name, npd_receipt_id, url, amount].hash
    end
