...
module Yookassa
  class PayoutDestinationDataType
    YOO_MONEY = "yoo_money".freeze
    BANK_CARD = "bank_card".freeze
    SBP = "sbp".freeze

    def self.all_vars
      @all_vars ||= [YOO_MONEY, BANK_CARD, SBP].freeze
    end
    ...
    def build_from_hash(value)
      return value if PayoutDestinationDataType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #PayoutDestinationDataType"
    end
  end
end
