...
module Yookassa
  class FiscalizationProvider
    ATOL = "atol".freeze
    AVANPOST = "avanpost".freeze
    A_QSI = "a_qsi".freeze
    BUSINESS_RU = "business_ru".freeze
    DIGITAL_KASSA = "digital_kassa".freeze
    EVOTOR = "evotor".freeze
    FIRST_OFD = "first_ofd".freeze
    KIT_INVEST = "kit_invest".freeze
    KOMTET = "komtet".freeze
    LIFE_PAY = "life_pay".freeze
    MERTRADE = "mertrade".freeze
    MODUL_KASSA = "modul_kassa".freeze
    ROCKET = "rocket".freeze
    SHTRIH_M = "shtrih_m".freeze

    def self.all_vars
      @all_vars ||= [ATOL, AVANPOST, A_QSI, BUSINESS_RU, DIGITAL_KASSA, EVOTOR, FIRST_OFD, KIT_INVEST, KOMTET, LIFE_PAY, MERTRADE, MODUL_KASSA, ROCKET, SHTRIH_M].freeze
    end
    ...
    def build_from_hash(value)
      return value if FiscalizationProvider.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FiscalizationProvider"
    end
  end
end
